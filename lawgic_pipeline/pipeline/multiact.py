...
# Αριθμ.-header splitting). ANAKOINOSI (a notice issue) and Π.Υ.Σ. (a Cabinet-act issue)
# are one act too — their id comes from the FEK coordinates.
PRIMARY_TYPES = {TYPE_NOMOS, TYPE_PD, TYPE_PNP, TYPE_AN, TYPE_ND,
                 TYPE_PSIFISMA, TYPE_KANVOULIS, TYPE_ANAKOINOSI, TYPE_PYS}
